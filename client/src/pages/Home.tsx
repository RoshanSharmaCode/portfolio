...
const projects = [
  {
    ...
    description:
      "QuickDine is a full-stack MERN platform that lets customers discover restaurants and reserve tables in real time, with dedicated dashboards for restaurant owners and administrators.",
  ...
  },
  {
    ...
    description:
      "A full-stack job portal built with the MERN stack, allowing job seekers to browse and apply for jobs while recruiters can create listings, manage applications, review resumes, and update application statuses.",
    image: asset("assets/projects/job-portal.png"),
    stack: [
      "React.js",
      "JavaScript",
      "Vite",
    ...
    github: "https://github.com/RoshanSharmaCode/Job-Portal",
    demo: "https://job-portal-client-self-chi.vercel.app",
  },
  {
    index: "03",
    name: "MERN Auth",
    ...
    description:
      "A full-stack MERN authentication system featuring secure registration, email verification with six-digit OTP, HTTP-only cookie sessions, and password reset functionality.",
  ...
  },
  {
    ...
    description:
      "A responsive cryptocurrency tracking application powered by the CoinGecko API, with live market data, detailed coin information, search, filtering, sorting, and interactive seven-day charts.",
    ...
    <div className="site-shell">
      ...
      <main id="top">
        <section className="hero-section">
          <div className="hero-copy">
            <p className="eyebrow hero-kicker">
              <span className="signal-dot" /> Open to full-time opportunities
            </p>
            <h1>
              Interfaces with
              <br />
            ...
            <div className="hero-actions">
              ...
              <a
                className="button button-quiet"
                href={resumeFile}
                download="Roshan-Sharma-Resume.pdf"
              >
          ...
          <div
            ...
            aria-label="Full-stack application system status panel"
          >
            <div className="system-panel">
              <div className="system-panel-head">
                <span>
                  <i className="signal-dot" /> runtime / portfolio
                </span>
                <span>v1.0.26</span>
              </div>
              <div className="system-map">
                ...
                <div className="system-node node-auth">
                  <span>AUTH</span>
                  <strong>JWT</strong>
                </div>
              ...
              <div className="system-panel-foot">
                <span>
                  <i className="signal-dot" /> all systems operational
                </span>
                <span>ship / learn / repeat</span>
              </div>
            </div>
          </div>
        ...
        <section id="about" className="content-section about-section">
          <SectionHeading
            number="01"
            eyebrow="Context / about"
            title="A builder who likes the details."
          />
          <div className="about-grid">
            ...
            <Reveal delay={0.08} className="about-body">
              <p>
              ...
              <p>
                Recently, I&apos;ve also been exploring AI-powered applications,
                especially the interface patterns that make emerging
                capabilities useful rather than noisy.
              </p>
            </Reveal>
          </div>
        </section>
        ...
        <section id="skills" className="content-section skills-section">
          <SectionHeading
            ...
            title="Tools I use to make things work."
          />
        ...
        <section id="experience" className="content-section experience-section">
          <SectionHeading
            number="03"
            eyebrow="Experience / selected"
            title="Learning in a real product loop."
          />
            ...
            <div className="experience-main">
              <div className="experience-title">
                <div>
                  ...
                  <h3>
                    MindMatrix <span>· Bengaluru</span>
                  </h3>
                </div>
                <BriefcaseBusiness size={24} />
              </div>
              <p className="experience-summary">
                Worked on a web-based asset management application, moving
                between reusable React components, CRUD flows, routing, state
                management, and the debugging work that keeps data persistent
                and in sync.
              </p>
              <div className="experience-points">
                <span>Reusable React components</span>
                <span>Client-side routing</span>
                <span>CRUD functionality</span>
        ...
        <section id="projects" className="content-section projects-section">
          <div className="projects-heading">
            <SectionHeading
              ...
              title="A few systems I've shipped and studied closely."
            />
            <a
              className="text-link"
              href="https://github.com/RoshanSharmaCode"
        ...
        <section className="content-section education-section">
          <div className="education-aside">
            <p className="eyebrow">05 / Foundation</p>
        ...
        <section className="content-section github-section">
          ...
          <div>
            ...
            <h2>
              ...
              <br />
              <span>The numbers stay honest.</span>
            </h2>
            ...
            <div className="hero-actions">
              <a
                ...
                rel="noreferrer"
              >
                Open GitHub profile <ArrowUpRight size={17} />
              </a>
              <a
                className="button button-quiet"
                href={resumeFile}
        ...
        <section id="contact" className="content-section contact-section">
          <div className="contact-copy">
            ...
            <p>
              Have a product problem, a full-stack role, or a good technical
              question? I&apos;d like to hear about it.
            </p>
            <div className="contact-links">
              <a href="mailto:roshansharma9379@gmail.com">
                roshansharma9379@gmail.com <ArrowUpRight size={15} />
              </a>
              <a
                href="https://www.linkedin.com/in/roshansharma9379/"
                target="_blank"
                rel="noreferrer"
              >
          ...
          <form
            ...
            onSubmit={event => {
              ...
              window.location.href = `mailto:roshansharma9379@gmail.com?subject=${subject}&body=${body}`;
              setFormState("ready");
            }}
          >
            ...
            <textarea
              ...
              required
              rows={4}
              placeholder="A few lines about the role, product, or idea..."
            />
            ...
            {formState === "ready" && (
              <p className="form-note">
                Your email app should open with a pre-filled draft. If it does
                not, email roshansharma9379@gmail.com directly.
              </p>
            )}
          </form>
        </section>
